      ...
      <section class="all-platforms-section">
        ...
        <div class="cards-grid">
          ...
          <div :class="['platform-card', detectedSystem.os === 'windows' ? 'highlight-border' : '']">
            ...
            <a :href="getDownloadUrl('windows', 'x64')" class="btn btn-secondary" :download="getFileName('windows', 'x64')">
              下载 Windows 版
            </a>
          </div>
          ...
          <div :class="['platform-card', (detectedSystem.os === 'macos' && detectedSystem.arch === 'arm64') ? 'highlight-border' : '']">
            ...
            <a :href="getDownloadUrl('macos', 'arm64')" class="btn btn-secondary" :download="getFileName('macos', 'arm64')">
              下载苹果芯片版
            </a>
          </div>
          ...
          <div :class="['platform-card', (detectedSystem.os === 'macos' && detectedSystem.arch === 'x64') ? 'highlight-border' : '']">
            ...
            <a :href="getDownloadUrl('macos', 'x64')" class="btn btn-secondary" :download="getFileName('macos', 'x64')">
              下载 Intel 芯片版
            </a>
          </div>
        </div>
...
const getDownloadUrl = (os, arch) => {
  ...
  if (downloadSource.value === 'oss') {
    // 拼接 OSS 下载格式，例如：https://download.onin.run/releases/v1.10.0/Onin_1.10.0_x64-setup.exe
