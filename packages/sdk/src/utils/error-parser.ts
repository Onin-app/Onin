...
export const httpErrorPatterns: ErrorPattern[] = [
  ...
  },
  {
    ...
    createError: (message, context) =>
      createError.http.networkError(message, {
  ...
  // Generic permission errors (low priority, placed last)
  {
    ...
    createError: (message, context) =>
      createError.common.permissionDenied(`URL: ${context?.url || 'unknown'}`, {
        originalError: message,
        ...context,
      }),
  },
...
export const fsErrorPatterns: ErrorPattern[] = [
  // Specific file system errors (high priority)
  {
    ...
    createError: (message, context) =>
      createError.fs.fileNotFound(context?.path || 'unknown', {
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.fs.fileAccessDenied(context?.path || 'unknown', {
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.fs.diskFull(context?.path || 'unknown', {
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.fs.fileAlreadyExists(context?.path || 'unknown', {
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.fs.invalidPath(context?.path || 'unknown', {
        originalError: message,
        ...context,
      }),
  },
  // Generic permission errors (low priority, placed last)
  {
    ...
    createError: (message, context) =>
      createError.common.permissionDenied(
...
export const clipboardErrorPatterns: ErrorPattern[] = [
  // Specific clipboard errors (high priority)
  {
    ...
    createError: (message, context) =>
      createError.clipboard.formatUnsupported(context?.format, {
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.clipboard.empty({ originalError: message, ...context }),
  },
  {
    patterns: ['clipboard access denied', 'clipboard ACCESS_DENIED'],
    createError: (message, context) =>
      createError.clipboard.accessDenied({
        originalError: message,
        ...context,
      }),
  },
  {
    ...
    createError: (message, context) =>
      createError.clipboard.unavailable({ originalError: message, ...context }),
  },
  // Generic permission errors (low priority, placed last)
  {
    patterns: ['Permission denied', 'permission denied', 'PERMISSION_DENIED'],
    createError: (message, context) =>
      createError.common.permissionDenied('clipboard access', {
        originalError: message,
        ...context,
      }),
  },
...
export const dialogErrorPatterns: ErrorPattern[] = [
  {
    ...
    createError: (message, context) =>
      createError.dialog.cancelled({ originalError: message, ...context }),
  },
  {
    patterns: [
      'unavailable',
    ...
    createError: (message, context) =>
      createError.dialog.unavailable({ originalError: message, ...context }),
  },
  {
    patterns: ['invalid options', 'INVALID_OPTIONS', 'malformed options'],
    createError: (message, context) =>
      createError.dialog.invalidOptions(context?.reason, {
        originalError: message,
        ...context,
      }),
  },
  {
    patterns: ['Permission denied', 'permission denied', 'PERMISSION_DENIED'],
    createError: (message, context) =>
      createError.common.permissionDenied('dialog access', {
        originalError: message,
        ...context,
      }),
  },
...
export function parseError(
  ...
  if (matchResult.matched && matchResult.pattern) {
    try {
      ...
      console.warn(
        'Failed to create specific error, falling back to generic error:',
        createError,
      );
    }
  }
 ...
 * @returns Parsed plugin error
 */
export function parseClipboardError(
  error: unknown,
  context?: Record<string, any>,
): PluginError {
 ...
 * @returns Parsed plugin error
 */
export function parseDialogError(
  error: unknown,
  context?: Record<string, any>,
): PluginError {
