...
{:else}
  <div class="h-[100vh] w-full bg-transparent p-1">
    <main
      class="border-border/70 bg-background text-foreground relative flex h-full w-full flex-col overflow-hidden rounded-2xl border p-3 shadow-2xl ring-1 ring-white/10 dark:ring-white/5"
