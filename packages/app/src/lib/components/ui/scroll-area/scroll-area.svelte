<script lang="ts">
  ...
  const defaultVerticalScrollbarClass =
    "bg-muted/30 hover:bg-muted/80 data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=hidden]:fade-out-0 data-[state=visible]:fade-in-0 flex w-1.5 touch-none rounded-full border-l border-l-transparent p-px transition-all duration-200 select-none hover:w-2.5 z-40";

  const defaultHorizontalScrollbarClass =
    "bg-muted/30 hover:bg-muted/80 data-[state=visible]:animate-in data-[state=hidden]:animate-out data-[state=hidden]:fade-out-0 data-[state=visible]:fade-in-0 flex h-1.5 touch-none rounded-full border-t border-t-transparent p-px transition-all duration-200 select-none hover:h-2.5 z-40";

  const defaultThumbClass =
    "bg-muted-foreground/50 hover:bg-muted-foreground/80 flex-1 rounded-full transition-colors";
</script>
